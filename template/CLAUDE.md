...
|----------|-----------|-------|---------------|
| **<project>-sre** | `.claude/agents/<project>-sre.md` | Read-only runtime investigation | Crashes, failures, metrics, resource pressure |
| **<project>-<role>** | `.claude/agents/<project>-<role>.md` | <description> | <trigger> |
